...
%   ??/2017 John Merryman NaN handling
%
% Usage:
%
...
% Goldstein and Werner, "Radar interferogram filtering for geophysical applications", 
% Geophys. Res. Lett., 1998.
%
% ph    : (input)  Complex interferogram
% n_win : (input)  Window size for 2D spectrum calculation.
% alpha : (output) 0 = no filtering, 1 = strong filtering.
%
% Example:
%   Iadf = goldstein_filt(complexInterf./abs(complexInterf), 64, 0.8);
%
